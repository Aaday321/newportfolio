...
import { SVG_PROPS } from '../../../assets/exportables'
import figma from './figma.svg'


function Logo({size, file, alt}:SVG_PROPS) {
  return (
   <img src={file} alt={alt||''} height={size || 50} width={size || 50} />
   /* <svg width={size || "50px"} height={size || "50px"} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
